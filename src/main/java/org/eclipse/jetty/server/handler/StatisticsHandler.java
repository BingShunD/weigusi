...
public class StatisticsHandler extends HandlerWrapper implements Graceful {
    ...
    public static class Httptrace{
        ...
        public Httptrace(String uri, String method, int status) {
            super();
            this.uri = uri;
            this.method = method;
            this.status = status;
    ...
    private final Map<Httptrace, SampleStatistic> tracesSum = new  ConcurrentHashMap<>();


    public Map<Httptrace, SampleStatistic> getTracesSum(){
        return tracesSum;
    }
    public static Httptrace extract(String path, Request baseRequest) {
        int status = baseRequest.getResponse().getStatus();
//        if(!baseRequest.isHandled()) {
//            status = 404;
//        }
        Httptrace trace = new Httptrace(path,baseRequest.getMethod(),status);
        return trace;
    }
...
//				}
            ...
            Httptrace httptrace = extract(path, baseRequest);
            tracesSum.computeIfAbsent(httptrace, k->new SampleStatistic()).set(dispatched);
...
//		_shutdown.cancel();
    ...
    /**
     * @return the number of requests handled by this handler since
     *         {@link #statsReset()} was last called, excluding active requests
    ...
    /**
     * @return the number of requests currently active. since {@link #statsReset()}
     *         was last called.
     */
    ...
    /**
     * @return the maximum number of active requests since {@link #statsReset()} was
     *         last called.
     */
    ...
    /**
     * @return the maximum time (in milliseconds) of request handling since
     *         {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the total time (in milliseconds) of requests handling since
     *         {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the mean time (in milliseconds) of request handling since
     *         {@link #statsReset()} was last called.
    ...
    /**
     * @return the number of dispatches seen by this handler since
     *         {@link #statsReset()} was last called, excluding active dispatches
     */
    ...
    /**
     * @return the number of dispatches currently in this handler since
     *         {@link #statsReset()} was last called, including resumed requests
     */
    ...
    /**
     * @return the max number of dispatches currently in this handler since
     *         {@link #statsReset()} was last called, including resumed requests
     */
    ...
    /**
     * @return the maximum time (in milliseconds) of request dispatch since
     *         {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the number of requests currently suspended. since
     *         {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the maximum number of current suspended requests since
     *         {@link #statsReset()} was last called.
     */
    ...
    /**
     * @return the milliseconds since the statistics were started with
     *         {@link #statsReset()}.
     */
...
//	}
    ...
    public String toString() {
        return String.format("%s@%x{%s,r=%d,d=%d}", getClass().getSimpleName(), hashCode(), getState(),
                _requestStats.getCurrent(), _dispatchedStats.getCurrent());
    }
    @Override
    public Future<Void> shutdown() {
        return null;
